...
import { javascriptFunctionalProgrammingAnswerArr } from './questionsAndAnswers/javascriptFunctionalProgrammingAnswers'; /* importing  array from other js file with webpack*/

import { javascriptFunctionalProgrammingQuestionArr } from './questionsAndAnswers/javascriptFunctionalProgrammingQuestions'; /* importing  array from other js file with webpack*/
...
checkPositive([1, 2, 3, -4, 5]);
    ...
    } else if (javascriptFunctionalProgrammingRandomValue == 20 && javascriptFunctionalProgrammingInputAnswer == javascriptFunctionalProgrammingAnswerArr[20].A20) {
        javascriptFunctionalProgrammingCorrectValue.innerHTML = "Correct..";
        javascriptFunctionalProgrammingDisplayAnswer.innerHTML = `
        <textarea name="text" class="answer_textarea" id="input">Good Job :) </textarea>`;
        javascriptFunctionalProgrammingNextButton.innerHTML = `<button class="nextButton javascriptColor1" onclick=javascriptFunctionalProgrammingBtn()>Next</button>`;
...
checkPositive([1, 2, 3, -4, 5]);
    ...
    } else if (javascriptFunctionalProgrammingRandomValue == 21 && javascriptFunctionalProgrammingInputAnswer == javascriptFunctionalProgrammingAnswerArr[21].A21) {
        javascriptFunctionalProgrammingCorrectValue.innerHTML = "Correct..";
        javascriptFunctionalProgrammingDisplayAnswer.innerHTML = `
        <textarea name="text" class="answer_textarea" id="input">Good Job :) </textarea>`;
        javascriptFunctionalProgrammingNextButton.innerHTML = `<button class="nextButton javascriptColor1" onclick=javascriptFunctionalProgrammingBtn()>Next</button>`;
